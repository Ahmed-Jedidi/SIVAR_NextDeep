...
def trigger_alert(name, frame):
    ...
    engine.say("Warning. An unknown person has been in the restricted area for more than 30 seconds.")
    engine.runAndWait()
            ...
            if person_box:
                ...
                for face_encoding in face_encodings:
                    ...
                    if True in matches:
                        ...
                        unknown_enter_time = None  # Reset
                    else:
                        print("❓ Unknown person detected")
                        if unknown_enter_time is None:
                            unknown_enter_time = time.time()
                        elif time.time() - unknown_enter_time > 10 and not alert_triggered:
